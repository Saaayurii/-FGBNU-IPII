...
export default function NewsletterPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case 'sent':
        return <Badge variant="default" className="bg-green-500">Отправлена</Badge>;
      case 'scheduled':
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-muted-foreground">Отправлено</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-muted-foreground">Черновиков</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-muted-foreground">Запланировано</p>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-muted-foreground">Получателей</p>
      ...
      {filteredNewsletters.length === 0 && !isLoading ? (
          ...
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-12">
              ...
              <p className="text-muted-foreground text-center mb-4">
                По вашему запросу не найдено ни одной рассылки. Попробуйте изменить критерии поиска.
              </p>
              <Button 
                variant="outline" 
                onClick={() => {
        ...
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-muted-foreground text-center mb-4">
              Вы еще не создали ни одной рассылки. Создайте первую рассылку для общения с подписчиками.
            </p>
            <Button asChild>
              <Link href="/admin/newsletter/create">
                <Plus className="h-4 w-4 mr-2" />
        ...
        <div className="grid gap-4">
          <div className="flex items-center justify-between">
            <p className="text-sm text-muted-foreground">
              Показано {filteredNewsletters.length} из {newsletters.length} рассылок
            </p>
          </div>
