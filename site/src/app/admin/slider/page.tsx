...
const mockSlides = [
  {
    ...
    description: 'Приглашаем принять участие в конференции молодых учёных 2024 года',
  ...
  },
  {
    ...
    description: 'Актуальная информация о программе грантов для молодых исследователей',
    imageUrl: '/api/placeholder/800/400',
    isActive: true,
    order: 2,
    ...
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{totalSlides - activeSlides}</div>
              <p className="text-xs text-muted-foreground">
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <div className="flex items-center gap-4 text-sm text-gray-500">
                              ...
                              <span>
                                Дата создания: {new Date(slide.createdAt).toLocaleDateString('ru-RU')}
                              </span>
                              {slide.link && (
                                <span>Ссылка: {slide.link}</span>
                              )}
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-2 ml-4">
                            <Badge 
                              ...
                              className={slide.isActive ? "bg-green-100 text-green-800" : ""}
                            >
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-sm text-gray-600 space-y-2">
              <p>Все слайды, которые вы добавляете, будут отображаться на главной странице.</p>
              <p>Рекомендуемый размер изображения: примерно 1200x600 пикселей.</p>
              <p>Активные слайды отображаются посетителям сайта, неактивные скрыты.</p>
              <p>Вы можете менять порядок слайдов с помощью стрелок вверх и вниз.</p>
            </div>
          </CardContent>
        </Card>
    </div>
